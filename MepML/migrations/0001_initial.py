# Generated by Django 2.2.28 on 2023-03-27 16:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(on_delete='cascade', to='MepML.Professor')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(on_delete='cascade', to='MepML.Professor')),
                ('dataset', models.ForeignKey(on_delete='cascade', to='MepML.Dataset')),
            ],
        ),
    ]
