...
CMD ["python3", "manage.py", "makemigrations", "--settings=djangoMepML.development_settings"]  
CMD ["python3", "manage.py", "migrate", "--run-syncdb", "--settings=djangoMepML.development_settings"]  
CMD ["python3", "manage.py", "database_init", "--settings=djangoMepML.development_settings"]
